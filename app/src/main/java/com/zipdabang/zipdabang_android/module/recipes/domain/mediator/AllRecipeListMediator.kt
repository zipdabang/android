...
import com.zipdabang.zipdabang_android.module.recipes.mapper.toRecipeAllEntity
...
class AllRecipeListMediator(
...
): RemoteMediator<Int, RecipeAllEntity>() {
    ...
    private suspend fun getRemoteKeyForLastItem(state: PagingState<Int, RecipeAllEntity>): RemoteKeysEntity? {
    ...
    private suspend fun getRemoteKeyForFirstItem(state: PagingState<Int, RecipeAllEntity>): RemoteKeysEntity? {
    ...
    private suspend fun getRemoteKeyClosestToCurrentPosition(state: PagingState<Int, RecipeAllEntity>): RemoteKeysEntity? {
