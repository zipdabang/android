...
import com.zipdabang.zipdabang_android.module.recipes.mapper.toRecipeFruitEntity
import com.zipdabang.zipdabang_android.module.recipes.mapper.toRecipeItemEntity
import kotlinx.coroutines.flow.first

@OptIn(ExperimentalPagingApi::class)
class FruitRecipeListMediator(
    private val recipeApi: RecipeApi,
    private val database: RecipeDatabase,
    private val datastore: DataStore<Token>,
    private val categoryId: Int = 6,
    private val orderBy: String,
    private val isNetworkAvailable: Boolean
): RemoteMediator<Int, RecipeFruitEntity>() {

    private val recipeListDao = database.recipeFruitDao()
    private val remoteKeyDao = database.recipeRemoteKeyDao()

    override suspend fun load(
        loadType: LoadType,
        state: PagingState<Int, RecipeFruitEntity>
    ): MediatorResult {
        return try {
    ...
    private suspend fun getRemoteKeyForLastItem(state: PagingState<Int, RecipeFruitEntity>): RemoteKeysEntity? {
    ...
    private suspend fun getRemoteKeyForFirstItem(state: PagingState<Int, RecipeFruitEntity>): RemoteKeysEntity? {
    ...
    private suspend fun getRemoteKeyClosestToCurrentPosition(state: PagingState<Int, RecipeFruitEntity>): RemoteKeysEntity? {
