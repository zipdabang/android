...
import com.zipdabang.zipdabang_android.module.recipes.mapper.toRecipeUserEntity
import com.zipdabang.zipdabang_android.module.recipes.mapper.toRecipeZipdabangEntity
import kotlinx.coroutines.flow.first
@OptIn(ExperimentalPagingApi::class)
class UserRecipeListMediator(
    private val recipeApi: RecipeApi,
    private val database: RecipeDatabase,
    private val datastore: DataStore<Token>,
    private val orderBy: String,
    private val isNetworkAvailable: Boolean
): RemoteMediator<Int, RecipeUserEntity>() {

    private val ownerType = OwnerType.USER.type

    private val recipeListDao = database.recipeUserDao()
    private val remoteKeyDao = database.recipeRemoteKeyDao()

    override suspend fun load(
        loadType: LoadType,
        state: PagingState<Int, RecipeUserEntity>
    ): MediatorResult {
        return try {
    ...
    private suspend fun getRemoteKeyForLastItem(state: PagingState<Int, RecipeUserEntity>): RemoteKeysEntity? {
    ...
    private suspend fun getRemoteKeyForFirstItem(state: PagingState<Int, RecipeUserEntity>): RemoteKeysEntity? {
    ...
    private suspend fun getRemoteKeyClosestToCurrentPosition(state: PagingState<Int, RecipeUserEntity>): RemoteKeysEntity? {
