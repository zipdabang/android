...
class CoffeeRecipeListMediator(
...
): RemoteMediator<Int, RecipeCoffeeEntity>() {

    private val recipeListDao = database.recipeCoffeeDao()
    private val remoteKeyDao = database.recipeRemoteKeyDao()

    override suspend fun load(
        loadType: LoadType,
        state: PagingState<Int, RecipeCoffeeEntity>
    ): MediatorResult {
        return try {
    ...
    private suspend fun getRemoteKeyForLastItem(state: PagingState<Int, RecipeCoffeeEntity>): RemoteKeysEntity? {
    ...
    private suspend fun getRemoteKeyForFirstItem(state: PagingState<Int, RecipeCoffeeEntity>): RemoteKeysEntity? {
    ...
    private suspend fun getRemoteKeyClosestToCurrentPosition(state: PagingState<Int, RecipeCoffeeEntity>): RemoteKeysEntity? {
