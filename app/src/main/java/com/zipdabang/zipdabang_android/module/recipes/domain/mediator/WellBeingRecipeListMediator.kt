...
import com.zipdabang.zipdabang_android.module.recipes.mapper.toRecipeWellBeingEntity
import kotlinx.coroutines.flow.first

@OptIn(ExperimentalPagingApi::class)
class WellBeingRecipeListMediator(
    private val recipeApi: RecipeApi,
    private val database: RecipeDatabase,
    private val datastore: DataStore<Token>,
    private val categoryId: Int = 7,
    private val orderBy: String,
    private val isNetworkAvailable: Boolean
): RemoteMediator<Int, RecipeWellBeingEntity>() {

    private val recipeListDao = database.recipeWellBeingDao()
    private val remoteKeyDao = database.recipeRemoteKeyDao()

    override suspend fun load(
        loadType: LoadType,
        state: PagingState<Int, RecipeWellBeingEntity>
    ): MediatorResult {
        return try {
    ...
    private suspend fun getRemoteKeyForLastItem(state: PagingState<Int, RecipeWellBeingEntity>): RemoteKeysEntity? {
    ...
    private suspend fun getRemoteKeyForFirstItem(state: PagingState<Int, RecipeWellBeingEntity>): RemoteKeysEntity? {
    ...
    private suspend fun getRemoteKeyClosestToCurrentPosition(state: PagingState<Int, RecipeWellBeingEntity>): RemoteKeysEntity? {
